...
(cl:defmethod cl:initialize-instance :after ((m <RangeArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RangeArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name coalas_pkg-msg:<RangeArray> is deprecated: use coalas_pkg-msg:RangeArray instead.")))
...
(cl:defmethod ranges-val ((m <RangeArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader coalas_pkg-msg:ranges-val is deprecated.  Use coalas_pkg-msg:ranges instead.")
  (ranges m))
